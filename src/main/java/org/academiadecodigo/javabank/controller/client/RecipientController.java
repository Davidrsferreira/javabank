package org.academiadecodigo.javabank.controller.client;
...
public class RecipientController {
    ...
    public String editRecipient(@PathVariable Integer cid, @PathVariable Integer id, Model model) throws JavaBankException {
        model.addAttribute("customer", customerToCustomerDto.convert(customerService.get(cid)));
    ...
    public String saveRecipient(@PathVariable Integer cid, @Valid @ModelAttribute("recipient") RecipientDto recipientDto, BindingResult bindingResult, RedirectAttributes redirectAttributes, Model model) throws JavaBankException {
