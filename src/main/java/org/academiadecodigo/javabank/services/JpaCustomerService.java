...
public class JpaCustomerService extends AbstractJpaService<Customer> implements CustomerService {
    ...
    /**
     * @see AbstractJpaService#AbstractJpaService(EntityManagerFactory, Class, TransactionManager)
     */
    public JpaCustomerService(EntityManagerFactory emf, TransactionManager tm) {
        super(emf, Customer.class, tm);
    }
