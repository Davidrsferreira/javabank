...
public class AccountTransactionView extends AbstractView {
    ...
    public void show() {
        ...
        if (customerHandler.getLoginCustomer().getAccountIds().size() == 0) {
            showNoAccounts();
            return;
        }
    ...
    private String buildAccountList() {
        ...
        for (Integer id :customerHandler.getLoginCustomer().getAccountIds()) {
            builder.append(id);
            builder.append(" ");
        }
    ...
    private int scanAccount() {
        ...
        Customer customer = customerHandler.getLoginCustomer();
